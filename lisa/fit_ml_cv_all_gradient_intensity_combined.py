...
for partition in partitions:
    ...
    # Load data
    # Note that for the gradient vectors the "intensity" is replaced by "gradient". All other things remain the same here. 
    ...
    pickle_fn = os.path.join(os.environ['HOME'], 'data', 'post_mortem', 'ml_clusters_cross_validated_%s', '%s_%s_%s_%s_%s.pkl' %(data_type, subject_id, fwhm, stain, n_clusters, partition['train_name']))
