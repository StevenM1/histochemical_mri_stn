...
df_uneven = pandas.read_pickle(os.path.join(os.environ['HOME'], 'data/post_mortem/dataframes/{subject_id}_{fwhm}_uneven_double_slices.pkl'.format(**locals())))
...
results_fn = os.path.join(os.environ['HOME'], 'data', 'post_mortem', 'ml_clusters_cross_validated', '{subject_id}_{fwhm}_{stain}_{n_clusters}.pandas'.format(**locals()))
results.to_pickle(results_fn)


pickle_even_fn = os.path.join(os.environ['HOME'], 'data', 'post_mortem', 'ml_clusters_cross_validated', '{subject_id}_{fwhm}_{stain}_{n_clusters}_even.pkl'.format(**locals()))
pkl.dump(s_even, open(pickle_even_fn, 'w'))

pickle_uneven_fn = os.path.join(os.environ['HOME'], 'data', 'post_mortem', 'ml_clusters_cross_validated', '{subject_id}_{fwhm}_{stain}_{n_clusters}_uneven.pkl'.format(**locals()))
